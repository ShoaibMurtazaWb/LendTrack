        ...
        <div className="page-canvas animate-fade-in">
          ...
          {isLoading ? (
            ...
            <EmptyState
              ...
              message="Chat with verified neighbors about shared items and loan updates."
              href="/contacts"
                ...
                if (!c.contact_id) {
                  return (
                    <div
                      ...
                      title="Link this neighbor in Contacts to open the thread"
                    >
                      {row}
                    </div>
                  );
